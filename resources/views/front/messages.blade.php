        ...
        <div class="custom_main_contents pt-5">
            <div class="live_feed_section d-flex flex-column pb-2">
                <div class="d-flex pb-3 e_live_feed_container border-bottom">
                    <span class="order-2">Message</span>
                    <!-- <img class="p-1 back_arrow order-1" id="account_options"
                        src="{{asset('assets/newimages/sidebaricons/chevronicon.svg')}}" alt="arrow"> -->
                </div>
                <div class="row mt-3">
                    <a href="{{ url('messages/chat') }}" class="col-12 d-flex chat_message py-2 justify-content-between notification_item_container">
                        <div class="d-flex">
                            <img src="{{asset('assets/newimages/thumbnail.svg')}}" class="profilePhoto_thumbnail" alt="">
                            <div class="d-flex flex-column ml-2">
                                <span class="title_message">Kings Wallace</span>
                                <span class="time_ago">Hope you're doing well? I sent you...</span>
                            </div>
                        </div>
                        <div class="d-flex flex-column align-items-end ml-2">
                            <span class="time_ago">8:32 AM</span>
                            <div class="unread_message_count">3</div>
                        </div>
                    </a>
                    <a href="{{ url('messages/chat') }}" class="col-12 d-flex chat_message py-2 justify-content-between notification_item_container">
                        <div class="d-flex">
