                ...
                <div class="row mt-4 pb-4 px-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex align-items-center" id="commentTrigger">
                                        <img id="commenticon" src="/assets/newimages/comment.svg" class="cursor_pointer"
                                            alt="">
                                        <span class="text-dark ml-1">{{ $eventDetails['event']->comment->count()
                                            }}</span>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-flex flex-column ml-2">
                                        ...
                                        <span class="time_ago">{{
                                            \Carbon\Carbon::parse($eventDetails['event']->created_at)->diffForHumans()}}</span>
                                    </div>
                                </div>
                                <div class="eventdetails_description mt-3">{{$eventDetails['event']->event_description}}
                                </div>
                                <div class="eventdetails_guide_container mt-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="d-flex align-items-center">
                                            <div
                                                ...
                                                <img src="{{asset('assets/newimages/bluelocation.svg')}}" alt="">
                                            </div>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="icon_container d-flex align-items-center justify-content-center">
                                                <img src="{{asset('assets/newimages/bluecalendar.svg')}}" alt="">
                                            </div>
                                            <div class="d-flex ml-2 flex-column align-items-start">
                                                <span
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="d-flex ml-2 flex-column align-items-start">
                                                <span class="distance_away">{{$eventDetails['event']->ticket_link ??
                                                    'N/A'}}</span>
                    ...
                    <div class="d-none col-12 px-0 flex-column" id="commentsHolder">
                        <div class="comment_container mt-4">
                            <textarea class="px-2 py-2" name="" id="" cols="2" rows="1"></textarea>
                            <button type="button" class="btn submit_comment">Send</button>
                        </div>
                        <div class="replies_container d-flex flex-column mt-4 p-3">
                            <div class="commenter_container mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <img class="commenter_photo" src="{{asset('assets/newimages/commenterphoto.svg')}}"
                                        alt="commenterphoto">
                                    <span class="commenter_name ml-3">Sandra Michael</span>
                                </div>
                                <div class="details">Hope you’re doing well? I sent you a waybill number, don’t know if
                                    you’ve seen it?</div>
                                <div class="time_posted text-right mt-2">10:23 AM</div>
                            </div>
                            <div class="commenter_container mb-3">
                                <div class="d-flex align-items-center mb-2">
                                    <img class="commenter_photo" src="{{asset('assets/newimages/commenterphoto.svg')}}"
        ...
        <div class="custom_rightbar pt-5 pl-4 pb-5">
            ...
            <div class="show_requests mt-4 p-3">
                <div class="d-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="d-flex justify-content-end"><a href="{{url('/notifications')}}" class="primary_color seeAllRequests">See
                            all</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 d-flex rightbar_event_live_feed mb-3">
                        <img src="{{asset('assets/newimages/thumbnail.svg')}}" class="rightbar_thumbnail" alt="">
                        <div class="d-flex flex-column justify-content-start align-items-start ml-3">
                            ...
                            <div class="d-flex align-items-center mt-1">
                                <img src="{{asset('assets/newimages/locationicon.svg')}}" class="" alt="">
