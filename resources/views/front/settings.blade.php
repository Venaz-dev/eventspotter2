    ...
    <div class="d-flex">
        ...
        <div class="custom_main_contents pt-5">
            <div class="live_feed_section d-flex flex-column pb-2">
                <a href="{{ url('profile') }}" style="color: #101010;">

                    <div class="d-flex pb-3 e_live_feed_container border-bottom">
                        <span class="order-2">Settings</span>
                ...
                <div class="row mt-5 pb-4 px-3">
                    <div class="px-0 mb-3 col-12 d-flex justify-content-between align-items-center">
                        <div class="details_private">Allow app to access location</div>
                        <div class="">
                            <label class="switch">
                                <input type="checkbox">
                    ...
                    <div class="px-0 mb-3 col-12 d-flex justify-content-between align-items-center">
                        <div class="details_private">Allow Direct Message</div>
                        <div class="">
                            <label class="switch">
                                <input type="checkbox">
                                <span class="slider"></span>
                    ...
                    <div class="px-0 mb-3 col-12 d-flex justify-content-between align-items-center">
                        <div class="details_private">Make profile private</div>
                        <div class="">
                            <label class="switch">
                                <input type="checkbox">
                                <span class="slider"></span>
