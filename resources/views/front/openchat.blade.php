...
<div class="container-fluid">
    <div class="d-flex">
        ...
        <div id="chat-page" class="custom_main_contents pt-5">
                ...
                <a href="{{ url('messages') }}" class="go-back">
                    <div class="d-flex pb-3 e_live_feed_container border-bottom">
                        ...
                        <div class="order-2 d-flex align-items-center">
                            <img class="chat_head_img mr-2" src="{{asset('assets/newimages/thumbnail.svg')}}" alt="arrow">
                            <span class="" style="font-weight:700;">King Wallace</span>
                        </div>
                        <img class="p-1 back_arrow order-1" id="account_options" src="{{asset('assets/newimages/sidebaricons/chevronicon.svg')}}" alt="arrow">
                    </div>
                </a>
                <div class="row all-messages mt-3">
                    <div class="col-12 user_chat_message mb-4">
                        <div class="col-6 d-flex flex-column">
                            <div class="user d-flex align-items-center">
                                <img class="user_photo mr-2" src="{{asset('assets/newimages/thumbnail.svg')}}" alt="thumbnail">
                                <span class="user_name">Sandra Michael</span>
                            </div>
                            <div class="user_message mt-1 pl-3 pr-4 py-3">
                                Hope you’re doing well? I sent you a waybill number, don’t know if you’’ve seen it?
                            </div>
                        </div>
                        <div class="message_time mt-1 text-center">10:23 AM</div>
                    </div>
                    <div class="col-12 user_chat_message_sender">
                        <div class="col-6 d-flex flex-column ml-auto">
                            <div class="user_message mt-1 pl-3 pr-4 py-3">
            ...
            <div class="send_message_container d-flex justify-content-between align-items-center">
                <textarea placeholder="Add a comment..." class="input_message_to_send" id="messageToSend"></textarea>
                <button class="btn send_btn">
                    <img class="" src="{{asset('assets/newimages/sendmessageicon.svg')}}" alt="sendmessageicon">
                </button>
            </div>
        </div>
        ...
        <div class="custom_rightbar pt-5 pl-4 pb-5">
            <form action="#" method="post">
                <div class="search_container">
                    ...
                    <img class="searchbar_icon" src="{{asset('assets/newimages/rightbaricons/searchicon.svg')}}" alt="searchicon">
                </div>
            </form>
